export default {
  ...
  'menu.demo.form': 'フォーム',
  'menu.demo.form.basic-form': '基本フォーム',
  'menu.demo.form.step-form': 'ステップフォーム',
  'menu.demo.form.step-form.info': 'ステップフォーム（転送情報の書き込み）',
  'menu.form.step-form.confirm': 'ステップフォーム（転送情報の確認）',
  'menu.demo.form.step-form.result': 'ステップフォーム（完成）',
  'menu.demo.form.advanced-form': '高度なフォーム',
  'menu.demo.list': 'リスト',
  'menu.demo.list.table-list': '検索テーブル',
  'menu.demo.list.basic-list': '基本リスト',
  'menu.demo.list.card-list': 'カードリスト',
  'menu.demo.list.search-list': '検索リスト',
  'menu.demo.list.search-list.articles': '検索リスト(記事)',
  'menu.demo.list.search-list.projects': '検索リスト(プロジェクト)',
  'menu.demo.list.search-list.applications': '検索リスト(アプリ)',
  'menu.profile': 'プロフィール',
